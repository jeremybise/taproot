    ...
    hooks: {
      'astro:config:setup': ({ injectRoute, addMiddleware, updateConfig, logger, config, command }) => {
        ...
        const adminRoutes: [string, string][] = [
          ...
          ['/settings/webhooks', 'settings/webhooks/index'],
          ['/settings/webhooks/[id]', 'settings/webhooks/[id]'],
        ...
        const apiRoutes: [string, string][] = [
          ...
          ['/items', 'items/index'],
          ['/items/[id]', 'items/[id]'],
          ['/items/[id]/children/reorder', 'items/[id]/children/reorder'],
          ['/items/[id]/duplicate', 'items/[id]/duplicate'],
          ['/items/[id]/subtree', 'items/[id]/subtree'],
