...
function wranglerConfig(name) {
  ...
  // cache-purge callback from the CMS to a consumer answered 404 for a URL that returned 401 to an
  // identical curl from outside, which reads as a missing route rather than a missing flag and
